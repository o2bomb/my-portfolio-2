...
<main class="flex-1">
  <section class="flex items-center justify-center min-h-screen">
    <h1 class="oswald-medium uppercase">Yong "Felix" TAN</h1>
  </section>
  <section class="relative min-h-screen">
    ...
    />
    <Card class="!absolute top-[10%] left-[20%]">
      <img
    ...
    <Card class="!absolute top-[40%] right-[40%]">
      <img
    ...
    <Card class="!absolute bottom-[10%] left-[10%]">
      <img
    ...
    <Card class="!absolute bottom-[20%] right-[10%]">
      <img
